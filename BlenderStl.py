...
bpy.ops.import_curve.svg(filepath=r"C:\Users\Archie\Documents\Making\BlenderScripts\Blender+Spotify\SpotifyCodeDownloads.svg", filter_glob="*.svg")

for obje in bpy.data.objects:
    obje.select_set(False)

for obj in bpy.data.collections['SpotifyCodeDownloads.svg'].all_objects:
    obj.select_set(True)
...
bpy.ops.transform.resize(value=(63.837, 63.837, 63.837))
bpy.ops.transform.translate(value=(-0.000509104, 0.00529022, 0.000980363))
...
bpy.ops.object.select_all(action='SELECT')
bpy.ops.export_mesh.stl(filepath=r"C:\Users\Archie\Documents\Making\BlenderScripts\Blender+Spotify\out.stl", use_selection=True, global_scale=1000)
