...
def main(URI):
    ...
    curve24 = bpy.data.objects['Curve.024']
    
    bpy.context.view_layer.objects.active = curve24
...
if (len(sys.argv)>1):
    ...
    print("Usage: python Spotifcode.py <URI>, using default")
    main('spotify:track:7DFj4U25OOZdVyddp3SMp5')
